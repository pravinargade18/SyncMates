...
//         <img src="/loader.svg" alt="loading..." width={100} height={100} />
//     </div>
...
const Loader = () => {
  return (
    <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center bg-c1">
      
      <XlviLoader
        className="loader" // Optional: You can add your custom CSS class to style the loader container.
        // backgound="bg-c1" // Optional: Background color of the loader container.
        boxColors={["#EF4444", "#F59E0B", "#6366F1"]} // Optional: Colors for the three animated boxes.
        size="64px" // Optional: Size of the loader. You can adjust the size of the loader by providing a valid CSS size (e.g., "64px", "50%", etc.).
        desktopSize="128px" // Optional: Size of the loader for desktop or laptop devices.
        mobileSize="64px" // Optional: Size of the loader for tablet or mobile devices.
      />
    </div>
  );
};
